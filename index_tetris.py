...
musica.set_volume(0.5)  # Ajustar el volumen a la mitad
...
def main():
    pygame.init()
    pygame.display.set_caption("Tetris for Coati Games")
    ...
    background_image = pygame.image.load("coati android.jpg").convert()
    ...
    try:
        font = pygame.font.Font("Roboto-Italic.ttf", 20)
    except OSError:
    ...
    game_over_text = font.render(
        "¡Gracias por participar!", True, (255, 220, 0), bgcolor)
